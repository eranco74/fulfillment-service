...
var _ ffv1.VirtualNetworksServer = (*VirtualNetworksServer)(nil)

type VirtualNetworksServer struct {
	ffv1.UnimplementedVirtualNetworksServer

	logger    *slog.Logger
	delegate  privatev1.VirtualNetworksServer
	inMapper  *GenericMapper[*ffv1.VirtualNetwork, *privatev1.VirtualNetwork]
	outMapper *GenericMapper[*privatev1.VirtualNetwork, *ffv1.VirtualNetwork]
}
...
func (b *VirtualNetworksServerBuilder) Build() (result *VirtualNetworksServer, err error) {
	...
	// Create the mappers:
	inMapper, err := NewGenericMapper[*ffv1.VirtualNetwork, *privatev1.VirtualNetwork]().
		SetLogger(b.logger).
		SetStrict(true).
		Build()
	if err != nil {
	...
	outMapper, err := NewGenericMapper[*privatev1.VirtualNetwork, *ffv1.VirtualNetwork]().
		SetLogger(b.logger).
		SetStrict(false).
		Build()
	if err != nil {
...
func (s *VirtualNetworksServer) List(ctx context.Context,
	request *ffv1.VirtualNetworksListRequest) (response *ffv1.VirtualNetworksListResponse, err error) {
	...
	publicItems := make([]*ffv1.VirtualNetwork, len(privateItems))
	for i, privateItem := range privateItems {
		publicItem := &ffv1.VirtualNetwork{}
	...
	response = &ffv1.VirtualNetworksListResponse{}
...
func (s *VirtualNetworksServer) Get(ctx context.Context,
	request *ffv1.VirtualNetworksGetRequest) (response *ffv1.VirtualNetworksGetResponse, err error) {
	...
	publicVirtualNetwork := &ffv1.VirtualNetwork{}
	...
	// Create the public response:
	response = &ffv1.VirtualNetworksGetResponse{}
	response.SetObject(publicVirtualNetwork)
	return
}

func (s *VirtualNetworksServer) Create(ctx context.Context,
	request *ffv1.VirtualNetworksCreateRequest) (response *ffv1.VirtualNetworksCreateResponse, err error) {
	...
	createdPublicVirtualNetwork := &ffv1.VirtualNetwork{}
	...
	// Create the public response:
	response = &ffv1.VirtualNetworksCreateResponse{}
	response.SetObject(createdPublicVirtualNetwork)
	return
}

func (s *VirtualNetworksServer) Update(ctx context.Context,
	request *ffv1.VirtualNetworksUpdateRequest) (response *ffv1.VirtualNetworksUpdateResponse, err error) {
	...
	updatedPublicVirtualNetwork := &ffv1.VirtualNetwork{}
	...
	// Create the public response:
	response = &ffv1.VirtualNetworksUpdateResponse{}
	response.SetObject(updatedPublicVirtualNetwork)
	return
}

func (s *VirtualNetworksServer) Delete(ctx context.Context,
	request *ffv1.VirtualNetworksDeleteRequest) (response *ffv1.VirtualNetworksDeleteResponse, err error) {
	// Create private request:
	...
	// Create the public response:
	response = &ffv1.VirtualNetworksDeleteResponse{}
	return
}
